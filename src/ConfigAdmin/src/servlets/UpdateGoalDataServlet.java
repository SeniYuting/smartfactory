...
/**
 * Servlet implementation class UpdateGoalDataServlet
 */
@WebServlet("/UpdateGoalDataServlet")
public class UpdateGoalDataServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public UpdateGoalDataServlet() {
		super();
	}
